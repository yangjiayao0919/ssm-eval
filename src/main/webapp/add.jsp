					...
					<div class="panel-body">
						<div class="form-group">
							...
							<div class="col-sm-5 inner">
								<input type="text" class="form-control" name="city" id="city" placeholder="城市">
				...
				<div class="panel panel-default col-sm-11 col-center-block">
					...
					<div class="panel-body">
						<div class="form-group">
							...
							<div class="col-sm-5 inner">
								<input type="text" class="form-control" name="spaceNum" id="spaceNum" placeholder="城市众创空间数量">
								<span class="help-block"></span>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5 inner">
								<input type="text" class="form-control" name="gdp" id="gdp" placeholder="城市年GDP">
								<span class="help-block"></span>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5 inner">
								<input type="text" class="form-control" name="companyNum" id="companyNum" placeholder="城市风险投资公司数量">
								<span class="help-block"></span>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5 inner">
								<input type="text" class="form-control" name="superCompanyNum" id="superCompanyNum" placeholder="城市融资1000万以上企业数量">
								<span class="help-block"></span>
							</div>
							<p class="form-control-static">（示例：0-100家，格式为数字取整数）</p>
						</div>
				...
				<div class="panel panel-default col-sm-11 col-center-block">
					...
					<div class="panel-body">
						<div class="form-group">
							...
							<div class="col-sm-5 inner">
								<input type="text" class="form-control" name="schoolNum" id="schoolNum" placeholder="城市高校数量">
								<span class="help-block"></span>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5 inner">
								<input type="text" class="form-control" name="peopleNum" id="peopleNum" placeholder="城市科技活动人员数量">
								<span class="help-block"></span>
							</div>
				...
				<div class="panel panel-default col-sm-11 col-center-block">
					...
					<div class="panel-body">
						<div class="form-group">
							...
							<div class="col-sm-5 inner">
								<input type="text" class="form-control" name="support" id="support" placeholder="城市或省政府政策支持度">
								<span class="help-block"></span>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5 inner">
								<input type="text" class="form-control" name="fever" id="fever" placeholder="城市的文化环境、创业热度">
								<span class="help-block"></span>
							</div>
							<p class="form-control-static">（示例：0-10，格式为数字取整数）</p>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-5 inner">
								<input type="text" class="form-control" name="facilities" id="facilities" placeholder="城市公共基础设施情况">
								<span class="help-block"></span>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5 inner">
								<input type="text" class="form-control" name="area" id="area" placeholder="城市人均公共绿地面积">
								<span class="help-block"></span>
							</div>
	...
	<script type="text/javascript">
		...
		$("#submit_btn").click(function(){
			if(validate_add_form()){
				$.ajax({
					type:'GET',
					url: '${APP_PATH}/saveEval',
					data: $('#add_form').serialize(),
					success: function(data){
						if(data!=null){
							window.location.href="${APP_PATH}/view?score="+data;
						}else{
							alert("保存失败，请重试！");
						}
					}
